...
export const metadata: Metadata = {
  title: 'World — Fanhattan Canon',
  description: 'The foundation of Fanhattan.',
};

export default function WorldPage() {
  const worldEntries = getCanonByCanonType('world');
      ...
      <section className="container mx-auto px-4 pt-32 pb-20">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-400">The foundation of Fanhattan.</p>
          </div>
          ...
          {worldEntries.length > 0 ? (
            <div className="space-y-6">
              {worldEntries.map((entry) => (
                <Link
                  ...
                  href={`/lore/${entry.frontmatter.slug}`}
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <CanonTierBadge tier={entry.frontmatter.canonTier} />
                  </div>
                  <p className="text-lg text-gray-300 italic">
                    &ldquo;{entry.frontmatter.coreBelief}&rdquo;
                  </p>
                </Link>
              ))}
            </div>
            ...
            <div className="text-center py-20">
              <p className="text-gray-400 text-lg">No world entries yet.</p>
            </div>
          )}
        </div>
      </section>
